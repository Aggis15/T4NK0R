...
class Help(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.pages = [
            discord.Embed(title="Welcome to the interactive help center for T4NK0R!", description="This guide is made "
                                                                                                  "for users who are "
                                                                                                  "interested in "
                                                                                                  "knowing how T4NK0R "
                                                                                                  "works! You can "
                                                                                                  ...
                                                                                                  "or Aggis15!",
                          color=0x00ff00),
            discord.Embed(title="Leveling System", description="Levels work just like you'd expect really.\n\nEvery 2 "
                          ...
                          color=0x00ff00),
            discord.Embed(title="Music", description="T4NK0R supports music functions!\n\n**Commands associated with "
                                                     ...
                                                     "Voice Channel.",
                          color=0x00ff00),
            discord.Embed(title="General Commands", description="This category is about general commands that didn't "
            ...
            discord.Embed(title="Admin Commands", description="This category is about commands that only server "
                          ...
                          color=0x00ff00),
            discord.Embed(title="Admin Commands - Twitch", description="This category is about twitch commands "
                          ...
                          color=0x00ff00),
            discord.Embed(title="Credits", description="Aggis - Bot Developer\nStarDelivery - Image "
