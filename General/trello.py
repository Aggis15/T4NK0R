...
class Trello(commands.Cog):
    ...
    async def reportbug(
        ...
        ctx,
        title: Option(
            str, "Bug title. Must be descriptive but not long", required=True
        ),
        description: Option(
            str,
        ...
        createCard = r.post(
            f"{trelloURL}?key={TRELLO_KEY}&token={TRELLO_TOKEN}",
            json=query,
    ...
    async def newfeature(
        self,
        ctx,
        title: Option(
            str, "New feature title. Must be descriptive but not long", required=True
        ),
        description: Option(
            str,
